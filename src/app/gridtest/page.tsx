...
export default function GridTestPage() {
  const gridOptions = [
    {
      title: "Handsontable",
      description: "Excel과 유사한 인터페이스를 제공하는 JavaScript 데이터 그리드",
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">그리드 테스트</h1>
        <p className="text-muted-foreground">다양한 JavaScript 데이터 그리드 라이브러리 테스트</p>
      </div>
