...
import { useOverseasSubsidiariesStore } from './store';
import { useGlobalStore } from '@/global/store/slices/global';

export default function OverseasSubsidiariesPage() {
  const { data, loading, error, fetchAllData } = useOverseasSubsidiariesStore();
