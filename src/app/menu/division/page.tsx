    ...
    <div className="min-h-screen bg-slate-50 p-4">
      ...
      <div className="mb-6 w-[90%] mx-auto">
        <div className="flex items-center gap-2 mb-2">
          ...
          <h1 className="text-2xl font-bold text-slate-800">HTNS 본사 부문별 당월실적 (5월)</h1>
        </div>
        <p className="text-base text-slate-500">HTNS Performance by Module 2025. May</p>
      </div>

      <div className="grid grid-cols-12 gap-6 h-[calc(90vh-12rem)] w-[90%] mx-auto">
        {/* 좌측 - 부문별 카드 테이블 형태 */}
        <div className="col-span-3">
          <Card className="p-7 shadow-sm h-full">
            {/* 헤더 */}
            ...
            <div className="space-y-3">
              {divisionData.map((division) => (
                <Card key={division.id} className={`${division.color} border-l-4 ${division.borderColor} overflow-hidden`}>
                  <div className="p-4">
            ...
            {/* 합계 카드 */}
            <Card className="bg-slate-600 text-white mt-4 border-0">
              <div className="p-4">
                <div className="grid grid-cols-12 gap-3 items-center">
